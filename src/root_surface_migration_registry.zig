...
pub const entries = [_]Entry{
    .{
        ...
        .target_path = "shift.Prompt",
        .status = .canonical_unchanged,
        .note = "Prompt descriptors stay canonical because the user explicitly locked prompt/comptime retention.",
    },
    .{
        .symbol = "PromptMode",
        .current_path = "shift.PromptMode",
        .target_path = "shift.PromptMode",
        .status = .canonical_unchanged,
        .note = "Prompt mode selection remains canonical and comptime-driven.",
    },
    .{
        .symbol = "ResumeOrReturn",
        .current_path = "shift.ResumeOrReturn",
        .target_path = "shift.ResumeOrReturn",
        .status = .canonical_unchanged,
        .note = "The optional-resumption decision type stays canonical at the root.",
    },
    .{
        .symbol = "ControlError",

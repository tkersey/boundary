...
pub const rows = [_]Row{
    ...
    .{
        ...
        .note = "Replace the public algebraic abortive-validation example with the ordinary-body canonical form.",
    },
    .{
        .replacement_id = "example.algebraic_artifact_search",
        .category = .example,
        .current_surface = "examples.algebraic_artifact_search",
        .current_signal = "parity_scenarios:algebraic_artifact_search",
        .law_anchor = formal_core.anchorPath(.public_algebraic_builders),
        .ordinary_target = "ordinary.example.algebraic_artifact_search",
        .note = "Replace the public algebraic artifact-search example with the ordinary-body canonical form.",
    },
    .{
        ...
        .status = .parity_green,
        .note = "The lexical state path now reproduces the canonical state fixture transcript through shift.with(...), but it is not yet the sole canonical public story.",
    },
    .{
        ...
        .status = .parity_green,
        .note = "The lexical reader path now reproduces the canonical reader fixture transcript through shift.with(...), but it is not yet the sole canonical public story.",
    },
    .{
        ...
        .status = .parity_green,
        .note = "The lexical optional path now reproduces the canonical optional fixture transcript through an explicit continuation-taking choice form in shift.with(...), but it is not yet the sole canonical public story.",
    },
    .{
        ...
        .status = .parity_green,
        .note = "The lexical exception path now reproduces the canonical exception fixture transcript through shift.with(...), but it is not yet the sole canonical public story.",
    },
    .{
        ...
        .status = .parity_green,
        .note = "The lexical resource path now reproduces the canonical resource fixture transcript through shift.with(...), but it is not yet the sole canonical public story.",
    },
    .{
        ...
        .status = .parity_green,
        .note = "The lexical writer path now reproduces the canonical writer fixture transcript through shift.with(...), but it is not yet the sole canonical public story.",
    },
    .{
        ...
        .note = "Replace generated transform-family authoring with ordinary-body generated operations and handlers.",
    },
    .{
        ...
        .status = .parity_green,
        .note = "The lexical generated choice path now reproduces the dedicated exact-output public example through shift.with(...), but it is not yet the sole canonical public story.",
    },
    .{
        ...
        .status = .parity_green,
        .note = "The lexical generated abort path now reproduces the dedicated exact-output public example through shift.with(...), but it is not yet the sole canonical public story.",
    },
};

...
/// Handler optional handle used by `boundary.effect handlers`.
...
/// Descriptor value used by `boundary.effect handlers` for the built-in optional family.
...
/// Create one handler optional descriptor for `boundary.effect handlers`.

...
pub fn LexicalHandle(
    ...
    return struct {
        ...
        pub fn request(self: @This(), comptime Continuation: type) shift.ResetError(family.ContextErrorSetType(ContextPtrType))!lexical_with.ChoiceAnswerType(Continuation) {
            ...
            return try prompt_support.run(self.runtime.?, authored.prompt, authored.program);
        }
    };
}
...
test "optional handle can return now without resuming the body tail" {
    ...
    const policy = struct {
        ...
        pub fn resumeOrReturn() prompt_support.ResumeOrReturn(i32, []const u8) {
            return prompt_support.ResumeOrReturn(i32, []const u8).returnNow("result=early");
        }
...
test "optional handle can resume and transform the resumed answer" {
    ...
    const policy = struct {
        ...
        pub fn resumeOrReturn() prompt_support.ResumeOrReturn(i32, []const u8) {
            return prompt_support.ResumeOrReturn(i32, []const u8).resumeWith(41);
        }

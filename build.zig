...
pub fn build(b: *std.Build) void {
    ...
    const examples = [_]struct {
        ...
        .{ .name = "boundary-world-surface-nested", .path = "examples/world_surface_nested.zig", .step = "run-world-surface-nested", .desc = "Run the nested Certified Boundary Target WorldSurface example." },

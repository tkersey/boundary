...
pub fn build(b: *std.Build) void {
    ...
    const compile_fail_owned_fixtures = [_]struct {
        ...
        .{ .name = "cf-public-ir-entry-value-param", .path = "test/compile_fail/public_ir_entry_value_param_fails.zig", .expected = "public lowering rejected entry functions with value parameters because run(runtime, handlers) cannot supply entry arguments" },

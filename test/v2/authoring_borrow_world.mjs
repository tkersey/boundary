...
if (!bundle || !imagePath || !sha256 || !nativePath)
  throw new Error('usage: node authoring_borrow_world.mjs BUNDLE IMAGE SHA NATIVE');
...
assert.deepEqual(outcome.value, Uint8Array.of(41, 0, 0, 0, 0, 0, 0, 0));
console.log(JSON.stringify({ protectedBorrow: 'completed 41',

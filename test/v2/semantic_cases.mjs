...
export const programNames = ['lexical','deep','recursive','choices-all','choices-first','generator',
  ...
  'handle-operand-order','protect-operand-order','successor-state','clause-payload','yielding-cleanup','borrow-operands','cleanup-disposal','cleanup-disposal-running','cleanup-disposal-failure','cleanup-disposal-owned','product-projection'];
...
add('product-projection-mutable','product-projection',[0]);
add('product-projection-failure','product-projection',[1]);

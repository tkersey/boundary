...
try {
  for(const kind of ['deep','shallow','transform_deep','transform_shallow','bypass','twice',
      'cleanup','lazy','demanded','failure_before','failure_after','match','configuration','region','arithmetic','arithmetic_fail','dispose','reusable_body','imported_scoped','cleanup_named','imported_sequence']) {

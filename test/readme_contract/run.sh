...
grep -q '`shift.ir`' "$readme"
grep -q 'compatibility-only' "$readme"
grep -q '`shift.Program(...)`, `shift.Decl`, `shift.Op`, `shift.Decision(...)`, and' "$readme"
grep -q '`shift.run(...)` remain supported compatibility surfaces' "$readme"

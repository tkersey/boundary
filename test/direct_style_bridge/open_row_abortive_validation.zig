...
/// Stable bridge case id for the open-row abortive validation example.
...
/// Run the canonical open-row abortive validation example through the current public surface.

...
const SourceProgram = ability.program("provider-program-mapper-fingerprint-reserved", struct {}, SourceBody);
...
const HandlerProgram = ability.program("provider-program-mapper-fingerprint-reserved-handler", struct {}, HandlerBody);

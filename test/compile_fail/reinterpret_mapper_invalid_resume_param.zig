...
const Body = struct {
    pub const compiled_plan = plan("reinterpret-invalid-resume-param");
};
const Program = boundary.program("reinterpret-invalid-resume-param", struct {}, Body);
...
const Mapper = struct {
    pub fn @"resume"(_: i32) Program.Handler.SourceOutcome(Site) {

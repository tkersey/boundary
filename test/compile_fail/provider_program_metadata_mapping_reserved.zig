...
const SourceProgram = ability.program("provider-program-metadata-mapping-reserved", struct {}, SourceBody);
...
const HandlerProgram = ability.program("provider-program-metadata-mapping-reserved-handler", struct {}, HandlerBody);

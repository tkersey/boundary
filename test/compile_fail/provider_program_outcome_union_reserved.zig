...
const SourceProgram = boundary.program("provider-program-outcome-union-reserved", struct {}, SourceBody);
...
const HandlerProgram = boundary.program("provider-program-outcome-union-reserved-handler", struct {}, HandlerBody);

...
const Program = ability.program("provider-harness-forged-program-mapping", struct {}, Body);
...
const ForgedProgramBackedEntry = struct {
    ...
    pub const semantic_body = Program.Evidence.SemanticBody.ability_program;
};

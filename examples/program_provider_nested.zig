...
const SourceProgram = ability.program("program-provider-nested-source", SourceHandlers, SourceBody);
...
const HandlerProgram = ability.program("program-provider-nested-handler", HandlerHandlers, HandlerBody);

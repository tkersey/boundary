...
fn render(list: *std.ArrayList(u8), allocator: std.mem.Allocator) !void {
    ...
    try list.appendSlice(allocator, "    \"contract\": \"shift.with and shift.effect author against one public runtime rooted at shift.Runtime, with RuntimeError as the named public failure surface while compile, lowering, ArtifactV1, interpreter, and durable mechanics remain internal engine layers\",\n");

...
def emit (output : System.FilePath) (scope : String) (entry : ProgramCache)
  ...
  let data ← writeModule output (scope ++ "Data") scope
    ...
    ("attribute [cbv_opaque] BoundaryV2.Profile.SHA256.hashNumerals BoundaryV2.Profile.SHA256.hash BoundaryV2.Profile.Target.Borrow.reachable BoundaryV2.Profile.Traits.check Nat.add\nattribute [cbv_eval] BoundaryV2.Profile.SHA256.hash_as_numerals BoundaryV2.Profile.Target.Borrow.reachable_forward BoundaryV2.Profile.Traits.check.eq_def BoundaryV2.Profile.Wire.Evaluation.nat_add_eval\n" ++ dataCode)

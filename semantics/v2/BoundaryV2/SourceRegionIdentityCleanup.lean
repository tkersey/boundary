  ...
  · simp only [except_bind_ok] at accepted
    ...
    · simp only [except_bind_ok, fromOption_ok] at accepted
      ...
      all_goals
        ...
        have created := allocate_nonregion_unique _ _ _ _ _ _ _ allocated (by first | rfl | (split <;> rfl)) outsideUnique
...
theorem installProtection_unique (machine : State) (context : Context) (body cleanup : Located)
  ...
  | some value =>
    ...
    | some descriptor =>
      ...
      have allocatedUnique := allocate_nonregion_unique _ _ _ _ _ _ _ allocated rfl (by exact next)
...
theorem executeEffectTerm_unique (machine : State) (context : Context) (after : Transition)
  ...
  · split at accepted <;> try contradiction
    exact enterRegion_unique _ _ _ _ _ _ formed bounded accepted
...
theorem unwindStep_unique (machine : State) (context : Context) (after : Transition)
  ...
  grind (gen := 32) only [except_bind_ok, fromOption_ok, → beginCleanup_unique, → cleanupFailed_unique]
